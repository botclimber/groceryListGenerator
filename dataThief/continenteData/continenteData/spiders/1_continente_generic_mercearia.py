...
class ContinentDataExtractor(scrapy.Spider):
	...
	name = "continenteData_mercearia"
	start_urls = ["https://www.continente.pt/mercearia/?start=0&srule=FOOD_Mercearia"]
	custom_settings = {
	...
	def parse(self, response):
		...
		if(self.totalProducts <= 0):
			...
			next_page = f"https://www.continente.pt/mercearia/?start={self.bunchOfCurrentProducts}&srule=FOOD_Mercearia"
			print(next_page)
